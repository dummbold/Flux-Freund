...
Nach der Einrichtung stehen die Daten am Port :3493 bereit (keine Website!). Man kann man die Daten in Linux mit dem NUX-Monitor anschauen (sehr rudimentär) aber sie auch problemlos in Homeassistant übernehmen! Es gibt eine NUT Integration die auf den Server zugreift und alle Daten in Homeassistant zur Verfügung stellt. Das sieht dann so aus:
